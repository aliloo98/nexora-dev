...
assert(getUserDisplayName({ email: 'alihakmaoui2017@example.com', user_metadata: {} }) === 'Vous', 'no email fallback')
assert(getUserDisplayName({ user_metadata: { username: 'alihakmaoui2017' } }) === 'Vous', 'technical username ignored')
