...
async function askJarvis(page, question) {
  ...
  await expect(page.locator('.jarvis-copilot-response')).toHaveCount(previousCount + 1, { timeout: 15000 })
...
test.describe('Jarvis Copilot V1', () => {
  ...
  test('2. Simplified mode preserves North Star and hides Copilot', async ({ page }) => {
